...
local commands = {
	commands = {
		{ cmd = '55', description = 'Проведение 10-55', text = '/m Водитель{get_storecar_model}, внимание!&/m Немедленно снизьте скорость и прижмитесь к обочине!&/m После остановки заглушите двигатель, держите руки на руле и не выходите из транспорта.&/m В случае неподчинения вы будете обьявлены в розыск, и по вам будет открыт огонь!', arg = '', enable = true, waiting = '3.250', bind = "[101]" },
		{ cmd = '66', description = 'Проведение 10-66', text = '/m Водитель{get_storecar_model}, внимание!&/m Немедленно снизьте скорость и прижмитесь к обочине!&/m В случае неподчинения вы будете обьявлены в розыск, и по вам будет открыт огонь!', arg = '', enable = true, waiting = '3.250', bind = "[102]" },
		{ cmd = 'zd' , description = 'Приветствие игрока' , text = 'Здраствуйте {get_ru_nick({arg_id})}&Я {my_ru_nick} - {fraction_rank} {fraction_tag}&Чем я могу Вам помочь?', arg = '{arg_id}' , enable = true , waiting = '2.350', bind = "{}" },
		{ cmd = 'bk' , description = 'Запрос помощи с координатами' , text = '/r {my_doklad_nick} - ДИСПЕТЧЕР. Срочно нужна помощь, высылаю свои координаты. КОД 1&/me достаёт свой КПК и отправляет координаты в базу данных {fraction_tag}&/bk 10-20', arg = '' , enable = true , waiting = '2.350', bind = "{}" },
		{ cmd = 'siren' , description = 'Вкл/выкл мигалок в т/с' , text = '{switchCarSiren}', arg = '' , enable = true , waiting = '2.350', bind = "{}" },
        { cmd = 'cure' , description = 'Поднять игрока из стадии' ,  text = '/me наклоняется над человеком, и прощупывает его пульс на сонной артерии&/cure {arg_id}&/do Пульс отсутствует.&/me начинает делать человеку непрямой массаж сердца, время от времени проверяя пульс&/do Спустя несколько минут сердце человека начало биться.&/do Человек пришел в сознание.&/todo Отлично*улыбаясь' , arg = '{arg_id}' , enable = true , waiting = '2.350' , bind = "{}"  },
		{ cmd = 'time' , description = 'Посмотреть время' ,  text = '/me взглянул{sex} на свои часы с гравировкой "Vanguard" и посмотрел{sex} время&/time' , arg = '' , enable = true, waiting = '2.350' , bind = "{}"  },
        { cmd = 'pas' , description = 'Запросить документы (МВД)' ,  text = 'Здраствуйте, управление {fraction_tag}, я {fraction_rank} {my_ru_nick}&/do Cлева на груди жетон полицейского, справа именная нашивка с именем.&/me  достаёт своё удостоверение из кармана&/showbadge {arg_id}&Прошу предъявить документ, удостоверяющий вашу личность.&/n {get_nick({arg_id})}, введите /showpass {my_id}' , arg = '{arg_id}' , enable = true , waiting = '2.350' , bind = "{}", in_fastmenu = true  },
        { cmd = 'doc' , description = 'Запросить документы (ФСБ)' ,  text = 'Здраствуйте, я {fraction_rank} {fraction_tag} {my_ru_nick}&/do Cлева на груди спец-жетон ФСБ.&/me указывает пальцем на свой спец-жетон на груди&Прошу предъявить документ, удостоверяющий вашу личность.&/n {get_nick({arg_id})}, введите /showpass {my_id} или /showbadge {my_id}' , arg = '{arg_id}' , enable = false , waiting = '2.350' , bind = "{}"  },
        { cmd = 'ts' , description = 'Выписать штраф' ,  text = '/do Бланк протокола и ручка находяться в нагрудном кармане.&/me достаёт из нагрудного кармана бланк протокола и ручку.&/me вписывает в бланк данные нарушителя&/ticket {arg_id} {arg2}&/do Бланк протокола заполнен.&/me передаёт бланк со штрафом нарушителю для дальнейшей оплаты' , arg = '{arg_id} {arg2}' , enable = true, waiting = '2.350' , bind = "{}"  },
        { cmd = 'pr' , description = 'Погоня за игроком' ,  text = '/me достаёт свой КПК и заходит в базу данных {fraction_tag}&/me открывает дело гражданина N-{arg_id} и нажимает на кнопку отслеживание местоположения&/pursuit {arg_id}&/me выходит с базы данных {fraction_tag} и выключив КПК убирает его на поясной держатель' , arg = '{arg_id}' , enable = true, waiting = '2.350' , bind = "{}"  },
		{ cmd = 'find' , description = 'Поиск игрока' ,  text = '/do КПК висит на поясном держателе.&/me достаёт свой КПК и включает его&/me заходит в базу данных {fraction_tag} и открывает дело гражданина N-{arg_id}&/do Данные успешно получены.&/me устанавливает в свой навигатор координаты гражданина N-{arg_id}&/do Навигатор получил координаты и построил ближайший путь.&/find {arg_id}&/me выходит с базы данных {fraction_tag} и выключив КПК убирает его на поясной держатель' , arg = '{arg_id}' , enable = true, waiting = '2.350' , bind = "{}"  },
        { cmd = 'su' , description = 'Выдать розыск' ,  text = '/me достаёт свой КПК и открывает базу данных преступников&/me вносит изменения в базу данных преступников&/do Преступник занесён в базу данных преступников.&/su {arg_id} {arg2} {arg3}&/z {arg_id}' , arg = '{arg_id} {arg2} {arg3}' , enable = true, waiting = '2.350' , bind = "{}" },
        { cmd = 'fsu' , description = 'Запросить выдачу розыска' ,  text = '/do Рация на тактическом поясе.&/me достаёт рацию и связавается с диспетчером&/me передаёт диспетчеру запрос на внесение человека в базу данных преступников&/r {my_doklad_nick} - ДИСПЕТЧЕР.&/r Прошу обьявить в розыск {arg2} степени дело {arg_id}. Причина {arg3}' , arg = '{arg_id} {arg2} {arg3}' , enable = true, waiting = '2.350' , bind = "{}"  },
		{ cmd = 'givefsu' , description = 'Выдача розыска по запросу офицера' ,  text = '/do Рация на тактическом поясе.&/me достаёт рацию и связавается с офицером для уточнения данных&/r 10-4, выдаю розыск по запросу офицера {get_rp_nick({arg_id})}!&/me достаёт свой КПК и открывает базу данных преступников&/me вносит изменения в базу данных преступников&/do Преступник занесён в базу данных преступиков.&/su {get_form_su} (по запросу офицера {get_rp_nick({arg_id})})&' , arg = '{arg_id}' , enable = true, waiting = '2.350' , bind = "{}"  },
		{ cmd = 'clear' , description = 'Снять розыск' ,  text = '/me достаёт свой КПК и открывает базу данных преступников&/me ищёт дело N{arg_id} и вносит изменения в базу данных преступников&/clear {arg_id}&/do Дело N{arg_id} больше не находится в списке разыскиваемых преступников.' , arg = '{arg_id}' , enable = true, waiting = '2.350' , bind = "{}"  },
        { cmd = 'cuff' , description = 'Надеть наручники' ,  text = '/do Наручники на тактическом поясе.&/me снимает наручники с пояса и надевает их на задержанного&/cuff {arg_id}&/do Задержанный в наручниках.' , arg = '{arg_id}' , enable = true , waiting = '2.350', bind = "{}" , in_fastmenu = true},
        { cmd = 'uncuff' , description = 'Снять наручники' ,  text = '/do На тактическом поясе прикреплены ключи от наручников.&/me снимает с пояса ключ от наручников и вставляет их в наручники задержанного&/me прокручивает ключ в наручниках и снимает их с задержанного&&/uncuff {arg_id}&/do Наручники сняты с задержанного&/me кладёт ключ и наручники обратно на тактический пояс', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },
        { cmd = 'gtm' , description = 'Повести за собой' ,  text = '/me схватывает задержанного за руки и ведёт его за собой&/gotome {arg_id}&/do Задержанный идёт в конвое.', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },
        { cmd = 'ungtm' , description = 'Перестать вести за собой' ,  text = '/me отпускает руки задержанного и перестаёт вести его за собой&/ungotome {arg_id}', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },
		{ cmd = 'gcuff' , description = 'Надеть наручники и вести за собой' ,  text = '/do Наручники на тактическом поясе.&/me снимает наручники с пояса и надевает их на задержанного&/cuff {arg_id}&/do Задержанный в наручниках.&/me схватывает задержанного за руки и ведёт его за собой&/do Задержанный идёт в конвое.&/gotome {arg_id}' , arg = '{arg_id}' , enable = true , waiting = '2.350', bind = "{}" },
		{ cmd = 'bot' , description = 'Изьять скрепки у игрока (взлом наручников)' ,  text = '/me увидел что задержанный использует скрепки для взлома наручников&/todo Вы что себе позволяете?!*изымая скрепки у {get_rp_nick({arg_id})}&/take {arg_id}' , arg = '{arg_id}' , enable = true , waiting = '2.350', bind = "{}", in_fastmenu = true },
		{ cmd = 'ss' , description = 'Кричалка' ,  text = '/s Всем поднять руки вверх, работает {fraction_tag}!', arg = '', enable = true, waiting = '2.350', bind = "{}" },
		{ cmd = 'frl' , description = 'Первичный обыск' ,  text = 'Сейчас я проверю у вас наличие оружия или других острых предметов, не двигайтесь.&/me прощупывает тело задержанного человека&/me прощупывает карманы задержанного человека', arg = '', enable = true, waiting = '2.350', bind = "{}" },
		{ cmd = 'fr' , description = 'Полный обыск' ,  text = '/do Резиновые перчатки на тактическом поясе.&/todo Сейчас я полностю обыщу вас, на наличие запрещенных предметов*надевая резиновые перчатки&/me прощупывает тело и карманы задержанного человека&/me достаёт из карманов задержанного все его вещи для изучения&/me внимательно осматривает все найденные вещи у задержанного человека&/frisk {arg_id}&/me снимает резиновые перчатки и убирает их на тактический пояск&/do Блокнот с ручкой в нагрудном кармане.&/me берет в руки блокнот с ручкой, и записывает всю информацию про обыск&/me сделав пометки, убирает блокнот с ручкой в нагрудный карман', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },
		{ cmd = 'take' , description = 'Изьятие предметов у игрока' , text = '/do В подсумке находиться небольшой зип-пакет.&/me достаёт из подсумка зип-пакет и отрывает его&/me кладёт в зип-пакет изьятые предметы задержанного человека&/take {arg_id}&/do Изьятые предметы в зип-пакете.&/todo Отлично*убирая зип-пакет в подсумок', arg = '{arg_id}' , enable = true , waiting = '2.350', bind = "{}", in_fastmenu = true  },
		{ cmd = 'camon' , description = 'Включить cкрытую боди камеру' ,  text = '/do К форме прикреплена скрытая боди камера.&/me незаметным движением руки включил{sex} боди камеру.&/do Скрытая боди камера включена и снимает всё происходящее.', arg = '', enable = true, waiting = '2.350', bind = "{}" },
		{ cmd = 'camoff' , description = 'Выключить cкрытую боди камеру' ,  text = '/do К форме прикреплена скрытая боди камера.&/me незаметным движением руки выключил{sex} боди камеру.&/do Скрытая боди камера выключена и больше не снимает всё происходящее.', arg = '', enable = true, waiting = '2.350', bind = "{}" },
		{ cmd = 'inc' , description = 'Затащить в транспорт' ,  text = '/me открывает заднюю дверь транспорта&/todo Наклоните голову, здесь дверь*затаскивая задержанного в транспортное средство&/incar {arg_id}&/me закрывает заднюю дверь транспорта&/do Задержанный в транспортном средстве.', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}" },
		{ cmd = 'ej' , description = 'Выбросить из транспорта',  text = '/me открывает дверь транспорта&/me помогает человеку выйти из транспорта&/eject {arg_id}&/me закрывает дверь транспорта', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },	
		{ cmd = 'pl' , description = 'Выбросить игрока из его транспорта',  text = '/me резким ударом дубинки разбивает стело транспорта задержанного&/pullout {arg_id}&/me выбрасывает задержанного из его транспорта и ударом дубинки оглушает его', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },	
		{ cmd = 'mr' , description = 'Зачитать права',  text = 'Вы имеете право хранить молчание.&Всё, что вы скажете, может и будет использовано против вас в суде.&Вы имеете право на 1 телефонный звонок, например для вызова частного адвоката.&Ваш адвокат может присутствовать при допросе.&Если вы не можете оплатить услуги адвоката, он будет предоставлен вам государством.&Вам ясны Ваши права?', arg = '', enable = true, waiting = '2.350', bind = "{}" },	
		{ cmd = 'unmask' , description = 'Снять балаклаву с игрока',  text = '/do Задержанный в балаклаве.&/me стягивает балаклаву с головы задеражнного&/unmask {arg_id}', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}" , in_fastmenu = true},
		{ cmd = 'arr' , description = 'Арестовать (в участке)',  text = '/me включает свой бортовой компютер и вводит код доступа сотрудника&/me заходит в раздел оформления протоколов задержаний и указывает данные&/do Протокол задержания заполнен.&/me вызывает по рации дежурный наряд участка и передаёт им задержанного человека&/arrest {arg_id}', arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true },
		{ cmd = 'drugs' , description = 'Провести Drugs Test' ,  text = '/do На тактическом поясе прикреплён подсумок.&/me открывает подсумок и достаёт из него набор Drugs Test&/me берёт из набора пробирку с этиловым спиром&/me засыпает найденное вещество в пробирку&/me достаёт из подсумка тест Имуно-Хром-10 и добавляет его в пробирку&/do В пробирке с этиловым спиртом находится неизвестное вещество и Имуно-Хром-10.&/me акуратными движениями взбалтывает пробирку&/do От теста Имуно-Хром-10 содержимое пробирки сменило цвет.&/todo Да, это точно наркотики*увидев что содержимое пробирки сменило цвет&/me убирает пробирку обратно в подсумок и закрывает его', arg = '', enable = true, waiting = '2.350', bind = "{}"},
		{ cmd = 'rbomb' , description = 'Деактивировать бомбу' ,  text = '/do На тактическом поясе прикреплён сапёрный набор.&/me снимает с пояса сапёрный набор и кладет его на землю, затем открывает его&/do Открытый сапёрный набор находится на земле.&/me достаёт из сапёрного набора пакет с жидким азотом и кладет его на землю&/me достаёт из сапёрного набора отвёртку&/do Отвертка в руках, а пакет с жидким азотом на земле.&/do На корпусе бомбы находится 2 болтика.&/me откручивает болтики с бомбы и убирает их вместе с отвёрткой в сторону&/me акуратным движением руки вскрывает крышку бомбы&/me внимательно осматривает бомбу&/do Внутри бомбы видна детонирующая часть.&/me достаёт из сапёрного набора кусачки&/do Кусачки в руках.&/me акуратным движением кусочок разрезает красный провод бомбы&/do Таймер остановился, тиканье со стороны бомбы не слышно.&/me берёт в руки охлаждающий пакет с жидким азотом и кладёт его детонирующую часть бомбы&/removebomb&/do Бомба обезврежена.&/me убирает кусачки и отвёртку обратно в саперный набор и закрывает его', arg = '', enable = true, waiting = '2.350', bind = "{}" },
		{ cmd = 'dismiss' , description = 'Увольнение (для 8+ ФСБ)' ,  text = '/do КПК находиться на поясном держателе.&/me берёт в руки свой КПК и включает его&/me заходит в базу данных {fraction_tag} и переходит в раздел управление сотрудниками других организаций&/me открывает дело нужного сотрудника и вносит в него изменения&/do Изменения успешно сохранены.&/dismiss {arg_id} {arg2}&/me выходит с базы данных {fraction_tag} и выключив КПК убирает его на поясной держатель', arg = '{arg_id} {arg2}', enable = false, waiting = '2.350', bind = "{}" },
	},
	commands_manage = {
		{ cmd = 'inv' , description = 'Принятие игрока в фракцию' , text = '/do В кармане есть связка с ключами от раздевалки.&/me достаёт из кармана один ключ из связки ключей от раздевалки&/todo Возьмите, это ключ от нашей раздевалки*передавая ключ человеку напротив&/invite {arg_id}&/n {get_ru_nick({arg_id})} , примите предложение в /offer чтобы получить инвайт!' , arg = '{arg_id}', enable = true, waiting = '2.350'  , bind = "{}", in_fastmenu = true  },
		{ cmd = 'gr' , description = 'Повышение/понижение cотрудника' , text = '{show_rank_menu}&/me достаёт из кармана свой телефон и заходит в базу данных {fraction_tag}&/me изменяет информацию о сотруднике {get_ru_nick({arg_id})} в базе данных {fraction_tag}&/me выходит с базы данных и убирает телефон обратно в карман&/giverank {arg_id} {get_rank}&/r Сотрудник {get_ru_nick({arg_id})} получил новую должность!' , arg = '{arg_id}', enable = true, waiting = '2.350', bind = "{}", in_fastmenu = true   },
		{ cmd = 'fmutes' , description = 'Выдать мут сотруднику (10 min)' , text = '/fmutes {arg_id} Н.У.&/r Сотрудник {get_ru_nick({arg_id})} лишился права использовать рацию на 10 минут!' , arg = '{arg_id}', enable = true, waiting = '2.350' , bind = "{}"   },
		{ cmd = 'funmute' , description = 'Снять мут сотруднику' , text = '/funmute {arg_id}&/r Сотрудник {get_ru_nick({arg_id})} теперь может пользоваться рацией!' , arg = '{arg_id}', enable = true, waiting = '2.350' , bind = "{}", in_fastmenu = true   },
		...
		{ cmd = 'unvig' , description = 'Снятие выговора cотруднику' , text = '/me достаёт из кармана свой телефон и заходит в базу данных {fraction_tag}&/me изменяет информацию о сотруднике {get_ru_nick({arg_id})} в базе данных {fraction_tag}&/me выходит с базы данных и убирает телефон обратно в карман&/unfwarn {arg_id}&/r Сотруднику {get_ru_nick({arg_id})} был снят выговор!' , arg = '{arg_id}', enable = true, waiting = '2.350' , bind = "{}" , in_fastmenu = true  },
		...
		{ cmd = 'point' , description = 'Установить метку для сотрудников' , text = '/r Срочно выдвигайтесь ко мне, отправляю вам координаты...&/point' , arg = '', enable = true, waiting = '2.350' , bind = "{}"  },
		{ cmd = 'govka' , description = 'Собеседование по госс.волне' , text = '/d [{fraction_tag}] - [Всем]: Занимаю государственную волну, просьба не перебивать!&/gov [{fraction_tag}]: Доброго времени суток, уважаемые жители нашего округа!&/gov [{fraction_tag}]: Сейчас проходит собеседование в организацию {fraction}}&/gov [{fraction_tag}]: Для вступления вам нужно иметь документы и приехать к нам в холл.&/d [{fraction_tag}] - [Всем]: Освобождаю  государственную волну, спасибо что не перебивали.' , arg = '', enable = true, waiting = '2.350', bind = "{}"  },
	}
}
...
function load_arzvehicles()
	if doesFileExist(path_arzvehicles) then
        ...
        if file then
            ...
            file:close()
			if #contents == 0 then
				print('[Vanguard Helper] Не удалось открыть файл с моделями каров родины!')
				print('[Vanguard Helper] Причина: этот файл пустой')
			else
				local result, loaded = pcall(decodeJson, contents)
				if result then
					arzvehicles = loaded
					print('[Vanguard Helper] Модели кастом каров родины инициализированы!')
				else
					print('[Vanguard Helper] Не удалось открыть файл с моделями каров родины!')
					print('[Vanguard Helper] Причина: Не удалось декодировать json (ошибка в файле)')
				end
...
function welcome_message()
	...
	if isMonetLoader() or settings.general.bind_mainmenu == nil or not settings.general.use_binds then	
		sampAddChatMessage('[Vanguard Helper] {ffffff}Чтоб открыть меню хелпера введите команду ' .. message_color_hex .. '/vanguard', message_color)
	elseif hotkey_no_errors and settings.general.bind_mainmenu and settings.general.use_binds then
		sampAddChatMessage('[Vanguard Helper] {ffffff}Чтоб открыть меню хелпера нажмите ' .. message_color_hex .. getNameKeysFrom(settings.general.bind_mainmenu) .. ' {ffffff}или введите команду ' .. message_color_hex .. '/vanguard', message_color)
	else
		sampAddChatMessage('[Vanguard Helper] {ffffff}Чтоб открыть меню хелпера введите команду ' .. message_color_hex .. '/vanguard', message_color)
	end
end
		...
		if not isActiveCommand then
			if isParamSampID(arg) then
				if #smart_uk ~= 0 then
					...
					sampAddChatMessage('[Vanguard Helper] {ffffff}Сначало загрузите/отредактируйте умный розыск в /vanguard', message_color)
					play_error_sound()
				end
			else
		...
		if not isActiveCommand then
			if isParamSampID(arg) then
				if #smart_pdd ~= 0 then
					...
					sampAddChatMessage('[Vanguard Helper] {ffffff}Сначало загрузите/отредактируйте умные штрафы в /vanguard', message_color)
					play_error_sound()
				end
			else
	...
	sampRegisterChatCommand("wanteds", function(arg)
		...
		elseif not isActiveCommand then
			lua_thread.create(function()
				...
				wanted_new = {}
				check_wanted = true
				local max_lvl = (settings.player_info.fraction_tag == 'ФСБ' or settings.player_info.fraction_tag == 'FBI') and 7 or 6
...
function show_fast_menu(id)
	if isParamSampID(id) then 
		sampAddChatMessage('[Vanguard Helper] {ffffff}Добавить/убрать команду из FastMenu можно в /vanguard - RP команды - Изменение, аргумент {arg_id}, галочка', message_color)
		player_id = tonumber(id)
		FastMenu[0] = true
	else
		if isMonetLoader() or settings.general.bind_fastmenu == nil then
			if not FastMenuPlayers[0] then
				sampAddChatMessage('[Vanguard Helper] {ffffff}Используйте ' .. message_color_hex .. '/vanm [ID]', message_color)
			end
		elseif settings.general.bind_fastmenu and settings.general.use_binds and hotkey_no_errors then
			sampAddChatMessage('[Vanguard Helper] {ffffff}Используйте ' .. message_color_hex .. '/vanm [ID] {ffffff}или наведитесь на игрока через ' .. message_color_hex .. 'ПКМ + ' .. getNameKeysFrom(settings.general.bind_fastmenu), message_color) 
		else
			sampAddChatMessage('[Vanguard Helper] {ffffff}Используйте ' .. message_color_hex .. '/vanm [ID]', message_color)
		end 
		play_error_sound()
...
function show_leader_fast_menu(id)
	if isParamSampID(id) then
		...
		if isMonetLoader() or settings.general.bind_leader_fastmenu == nil then
			sampAddChatMessage('[Vanguard Helper] {ffffff}Используйте ' .. message_color_hex .. '/vanlm [ID]', message_color)
		elseif settings.general.bind_leader_fastmenu and settings.general.use_binds and hotkey_no_errors then
			sampAddChatMessage('[Vanguard Helper] {ffffff}Используйте ' .. message_color_hex .. '/vanlm [ID] {ffffff}или наведитесь на игрока через ' .. message_color_hex .. 'ПКМ + ' .. getNameKeysFrom(settings.general.bind_leader_fastmenu), message_color) 
		else
			sampAddChatMessage('[Vanguard Helper] {ffffff}Используйте ' .. message_color_hex .. '/vanlm [ID]', message_color)
		end 
		play_error_sound()
...
function getNameOfARZVehicleModel(id)
	...
	if doesFileExist(path_arzvehicles) then
		if arzvehicles and #arzvehicles ~= 0 then
			...
			sampAddChatMessage('[Vanguard Helper] {ffffff}Не удалось получить модель т/c с ID ' .. id .. "! Причина: ошибка инициализации VehiclesRodina.json", message_color)
			need_download_arzveh = true
		end
	else
		sampAddChatMessage('[Vanguard Helper] {ffffff}Не удалось получить модель т/c с ID ' .. id .. "! Причина: отсуствует файл VehiclesRodina.json", message_color)
		need_download_arzveh = true
	end
		...
		downloadToFile(url, path, function(type, pos, total_size)
			...
			elseif type == "finished" then
				...
				elseif download_arzvehicles then
					sampAddChatMessage('[Vanguard Helper] {ffffff}Загрузка списка моделей кастом каров родины заверешена успешно!',  message_color)
...
function sampev.onShowDialog(dialogid, style, title, button1, button2, text)
    if title:find('Статистика игрока') and check_stats then -- получение статистики
        -- Исправленные шаблоны поиска
        if text:find("{ffffff}Имя %(рус%.%):") then
        ...
        if text:find("{ffffff}Пол:") then
            settings.player_info.sex = text:match("{ffffff}Пол:%s+{BE433D}([^\n\r]+)")
        ...
        if text:find("{ffffff}Организация:") then
            settings.player_info.fraction = text:match("{ffffff}Организация:%s+{BE433D}([^\n\r]+)")
        ...
        if text:find("{ffffff}Должность:") then
            local rank_line = text:match("{ffffff}Должность:%s+{BE433D}([^\n\r]+)")
            if rank_line then
 		...
 		if id == 220 then
 			...
 			if raknetBitStreamReadInt8(bs) == 17 then
				...
				local cmd = (encoded ~= 0) and raknetBitStreamDecodeString(bs, length + encoded) or raknetBitStreamReadString(bs, length)
 				...
 				if cmd:find('Статистика игрока') and check_stats then -- /vanme
		...
		if imgui.BeginTabBar('пон') then	
			if imgui.BeginTabItem(fa.HOUSE..u8' Главное меню') then
				...
				if imgui.BeginChild('##4', imgui.ImVec2(589 * settings.general.custom_dpi, 28 * settings.general.custom_dpi), true) then
					imgui.Columns(2)
					imgui.Text(fa.HAND_HOLDING_DOLLAR .. u8" Вы можете финансово поддержать автора скрипта (Milky) донатом " .. fa.HAND_HOLDING_DOLLAR)
					imgui.SetColumnWidth(-1, 480 * settings.general.custom_dpi)
					imgui.NextColumn()
					...
					if imgui.BeginPopupModal(fa.SACK_DOLLAR .. u8' Поддержка разработчика', _, imgui.WindowFlags.NoCollapse  + imgui.WindowFlags.NoResize + imgui.WindowFlags.NoScrollbar) then
						change_dpi()
						if not isMonetLoader() then imgui.SetWindowFontScale(settings.general.custom_dpi) end
						imgui.CenterText(u8'Свяжитесь с Milky:')
				...
				if imgui.BeginTabBar('Tabs2') then
					...
					if imgui.BeginTabItem(fa.BARS..u8' RP команды (общие)') then 
						...
						if imgui.Button(fa.CIRCLE_PLUS .. u8' Создать новую команду##new_cmd',imgui.ImVec2(imgui.GetMiddleButtonX(1), 0)) then
							...
							local new_cmd = {cmd = '', description = '', text = '', arg = '', enable = true, waiting = '2.350', bind = "{}" }
							...
							waiting_slider = imgui.new.float(2.350)
					...
					if imgui.BeginTabItem(fa.BARS..u8' Доп. функции') then 
						if imgui.BeginChild('##999', imgui.ImVec2(589 * settings.general.custom_dpi, 333 * settings.general.custom_dpi), true) then
							if isMonetLoader() then
								if imgui.Checkbox(u8(' Отображение кнопки "Взаимодействие" (аналог /vanm ID)'), checkbox_mobile_fastmenu_button) then
								...
								if hotkey_no_errors then
									if settings.general.use_binds then
										...
										if settings.general.use_binds and hotkey_no_errors then
											imgui.Separator()
											imgui.CenterText(u8'Открытие главного меню хелпера (аналог /vanguard):')
											...
											imgui.Separator()
											imgui.CenterText(u8'Открытие быстрого меню взаимодействия с игроком (аналог /vanm):')
											...
											imgui.Separator()
											imgui.CenterText(u8'Открытие быстрого меню управления игроком (аналог /vanlm):')
											imgui.CenterText(u8'Навестись на игрока через ПКМ и нажать')
											local width = imgui.GetWindowWidth()
			...
			if imgui.BeginTabItem(fa.STAR .. u8' Розыск и штрафы') then 
					...
					if imgui.BeginPopupModal(fa.STAR .. u8' Система умного розыска##smartuk', _, imgui.WindowFlags.NoCollapse  + imgui.WindowFlags.NoResize ) then
						...
						for chapter_index, chapter in ipairs(smart_uk) do
							...
							if imgui.Button(fa.TRASH_CAN .. '##' .. chapter_index) then
								imgui.OpenPopup(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##' .. chapter_index)
							end
							if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##' .. chapter_index, _, imgui.WindowFlags.NoResize ) then
								change_dpi()
									...
									if chapter.item then
										for index, item in ipairs(chapter.item) do
											...
											if imgui.Button(fa.TRASH_CAN .. '##' .. chapter_index .. '##' .. index) then
												imgui.OpenPopup(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##' .. chapter_index .. '##' .. index)
											end
											if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##' .. chapter_index .. '##' .. index, _, imgui.WindowFlags.NoResize ) then
												change_dpi()
					...
					if imgui.BeginPopupModal(fa.TICKET .. u8' Система умных штрафов##smartpdd', _, imgui.WindowFlags.NoCollapse  + imgui.WindowFlags.NoResize ) then
						...
						for chapter_index, chapter in ipairs(smart_pdd) do
							...
							if imgui.Button(fa.TRASH_CAN .. '##smartpdd' .. chapter_index) then
								imgui.OpenPopup(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##smartpdd' .. chapter_index)
							end
							if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##smartpdd' .. chapter_index, _, imgui.WindowFlags.NoResize ) then
								change_dpi()
								imgui.CenterText(u8'Вы действительно хотите удалить пункт?')
								imgui.CenterText(u8(chapter.name))
								imgui.Separator()
									...
									if chapter.item then
										for index, item in ipairs(chapter.item) do
											...
											if imgui.Button(fa.TRASH_CAN .. '##' .. chapter_index .. '###smartpdd' .. index) then
												imgui.OpenPopup(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##smartpdd' .. chapter_index .. '##' .. index)
											end
											if imgui.BeginPopupModal(fa.TRIANGLE_EXCLAMATION .. u8' Vanguard_Helper - Предупреждение ##smartpdd' .. chapter_index .. '##' .. index, _, imgui.WindowFlags.NoResize ) then
												change_dpi()
												imgui.CenterText(u8'Вы действительно хотите удалить подпункт?')
												imgui.CenterText(u8(item.text))
												imgui.Separator()
				...
				imgui.CenterText(u8'Облачные розыск/штрафы устарели? Сообщите мне.')
			imgui.EndTabItem()
			end
			if imgui.BeginTabItem(fa.FILE_PEN..u8' Заметки') then 
				...
				for i, note in ipairs(notes.note) do
					...
					if imgui.SmallButton(fa.PEN_TO_SQUARE .. '##' .. i) then
						...
						input_text_note = imgui.new.char[6555536](u8(note_text))
						input_name_note = imgui.new.char[10024](u8(note.note_name))
					...
					if imgui.BeginPopupModal(fa.PEN_TO_SQUARE .. u8' Изменение заметки' .. '##' .. i, _, imgui.WindowFlags.NoCollapse  + imgui.WindowFlags.NoResize ) then
						...
						if imgui.BeginChild('##9992', imgui.ImVec2(589 * settings.general.custom_dpi, 360 * settings.general.custom_dpi), true) then	
							...
							imgui.InputText(u8'##note_name', input_name_note, 6256)
							imgui.InputTextMultiline("##note_text", input_text_note, 1666384, imgui.ImVec2(578 * settings.general.custom_dpi, 320 * settings.general.custom_dpi))
							imgui.EndChild()
						end	
						if imgui.Button(fa.CIRCLE_XMARK .. u8' Отмена', imgui.ImVec2(imgui.GetMiddleButtonX(2), 0)) then
							imgui.CloseCurrentPopup()
			...
			if imgui.BeginTabItem(fa.GEAR..u8' Настройки') then 
				...
				if monet_no_errors then
					...
					if imgui.RadioButtonIntPtr(u8" Vanguard Theme | "..fa.TRIANGLE_EXCLAMATION .. u8' Ошибка: отсуствуют файлы библиотеки!', theme, 1) then
						theme[0] = 0
					end
				end
				imgui.EndChild()
    ...
    function(player)
		...
		if patrool_active then
			...
			if imgui.Button(fa.CIRCLE_INFO .. u8(' Доклад'), imgui.ImVec2(100 * settings.general.custom_dpi, 25 * settings.general.custom_dpi)) then
				lua_thread.create(function ()
					sampSendChat('/r ' .. tagReplacements.my_doklad_nick() .. ' - ДИСПЕТЧЕР.')
					wait(3100)
	...
	while true do
		...
		if nowGun ~= getCurrentCharWeapon(PLAYER_PED) and settings.general.rp_gun then
			...
			if not isExistsWeapon(oldGun) then
				...
				sampAddChatMessage('[Vanguard Helper] {ffffff}Изменить имя или расположение оружия вы можете в /vanguard - Главное меню - Режим RP отыгровки оружия - Настроить', message_color)
